...
-- DROP TABLE cdm.users;

CREATE TABLE cdm.users (
	id varchar NOT NULL,
...
-- DROP TABLE cdm.users_stations_link;

CREATE TABLE cdm.users_stations_link (
	user_id varchar NULL,
	station_id varchar NULL,
	CONSTRAINT users_stations_link_station_id_fkey FOREIGN KEY (station_id) REFERENCES cdm.stations(id),
	CONSTRAINT users_stations_link_user_id_fkey FOREIGN KEY (user_id) REFERENCES cdm.users(id)
);
